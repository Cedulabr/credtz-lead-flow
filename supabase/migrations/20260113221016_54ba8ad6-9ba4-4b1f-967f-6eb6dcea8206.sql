-- Add tag column to leads_database table
ALTER TABLE public.leads_database 
ADD COLUMN IF NOT EXISTS tag text;

-- Add tag column to leads table
...
-- Create function to get available tags with counts
...
-- Update request_leads_with_credits to support tag filter
...
-- Update import_leads_from_csv to support tag
