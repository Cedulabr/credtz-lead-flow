                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        {calcResult.installmentValue && (
                          <div>
                            ...
                            <p className="font-bold text-green-700">R$ {Number(calcResult.installmentValue).toFixed(2)}</p>
                          </div>
                        )}
                  ...
                  <CardContent className="space-y-3 text-sm">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      {calcResult?.loanValue && (
                        <div>
                          <span className="text-muted-foreground">Valor Liberado:</span>
                          <p className="font-bold text-green-600">R$ {Number(calcResult.loanValue).toFixed(2)}</p>
                        </div>
                      )}
