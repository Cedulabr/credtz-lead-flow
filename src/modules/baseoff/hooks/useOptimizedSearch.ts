      ...
      try {
        ...
        const transformedClients: BaseOffClient[] = results.map((row: any) => {
          ...
          return {
            ...
            ddb: flat.ddb || flat.DDB || null,
            dib: flat.dib || flat.DIB || null,
            esp: flat.esp || flat.ESP || flat.especie || null,
            sexo: flat.sexo || flat.SEXO || null,
            nome_mae: flat.nome_mae || flat.nomemae || flat.NOME_MAE || null,
            nome_pai: flat.nome_pai || flat.nomepai || null,
            naturalidade: flat.naturalidade || null,
            representante: flat.representante || null,
            bloqueio: flat.bloqueio || null,
            pensao_alimenticia: flat.pensao_alimenticia || null,
