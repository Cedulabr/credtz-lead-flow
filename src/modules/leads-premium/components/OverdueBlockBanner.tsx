...
interface OverdueBlockBannerProps {
  overdueLeads: OverdueLead[];
  onLeadClick?: (leadId: string) => void;
}

export function OverdueBlockBanner({ overdueLeads, onLeadClick }: OverdueBlockBannerProps) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-bold text-destructive">
            🚫 Leads Vencidos — Novas retiradas bloqueadas
          </h3>
                ...
                <div className="flex items-center gap-3">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Retirado {formatDistanceToNow(new Date(lead.withdrawn_at), { addSuffix: true, locale: ptBR })}
                    </p>
                  </div>
                </div>
