        ...
        <div className="min-h-[280px] py-2">
          {result ? (
            ...
            <div className="space-y-3">
              ...
              <OptionCard icon="💼" title="Convênios" description="Módulo Convênios (Margem + Empréstimos)" selected={convenio === 'CONVENIOS'} onClick={() => { setConvenio('CONVENIOS'); setSubtipo(null); setEstado(null); }} />
            </div>
          ) : currentStep === 'subtipo' ? (
            <div className="space-y-3">
